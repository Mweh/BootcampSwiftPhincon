...
enum SFSymbol {
    ...
    static let discoverSymbol = UIImage(systemName: "play.rectangle.on.rectangle.circle")
    ...
    static let discoverFillSoonSymbol = UIImage(systemName: "play.rectangle.on.rectangle.circle.fill")
